// ––– CodeForces Round #824: Problem D –––
...
bool TC() {
  /* rtn true; // Uncomment this line for multiple test cases *1/ */
  rtn false;
}
  ...
  FOR(i, 0, n) {
    FOR(k, i + 1, n) {
      FOR(l, k + 1, n) {
        bool x = true;
        FOR(o, 0, m) {
          if (!((a[i][o] == 0 && a[k][o] == 0 && a[l][o] == 0) ||
                (a[i][o] == 1 && a[k][o] == 1 && a[l][o] == 1) ||
                (a[i][o] == 2 && a[k][o] == 2 && a[l][o] == 2) ||
                (a[i][o] == 0 && a[k][o] == 1 && a[l][o] == 2) ||
                (a[i][o] == 0 && a[k][o] == 2 && a[l][o] == 1) ||
                (a[i][o] == 1 && a[k][o] == 0 && a[l][o] == 2) ||
                (a[i][o] == 1 && a[k][o] == 2 && a[l][o] == 0) ||
                (a[i][o] == 2 && a[k][o] == 0 && a[l][o] == 1) ||
                (a[i][o] == 2 && a[k][o] == 1 && a[l][o] == 0))) {
            x = false;
            break;
          }
        }
